...
/*--------------------------------------------------------------
# display words based on selected letter
--------------------------------------------------------------*/
...
// // Get all the word items
// const words = document.querySelectorAll('.word');

// // Function to filter words based on clicked letter
// alphabetButtons.forEach(button => {
//   button.addEventListener('click', function () {
//     const letter = this.getAttribute('data-letter'); // Get the clicked letter

//     // Hide all words first
//     words.forEach(word => {
//       word.style.display = 'none'; // Hide all words initially
//     });

//     // Show only the words that match the clicked letter
//     words.forEach(word => {
//       if (word.getAttribute('data-letter') === letter) {
//         word.style.display = 'block'; // Show the words with the matching letter
//       }
//     });
//   });
// });
...
//       // Check if the filter is 'all' or if the item matches the filter
